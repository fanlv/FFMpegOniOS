...
+ (id)initForDecodeAudioFile:(NSString *)filePathIn toPCMFile:(NSString *)filePathOutput
{
    ...
    AVCodecParameters *p_audio_codec_parameters = pAudioFormatCtx->streams[audioStream]->codecpar;
    pAudioCodec = avcodec_find_decoder(p_audio_codec_parameters->codec_id);
    pAudioCodeCtx = avcodec_alloc_context3(NULL);
    avcodec_parameters_to_context(pAudioCodeCtx, p_audio_codec_parameters);
